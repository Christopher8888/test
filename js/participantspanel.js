...
function() {
    /*mencari tag yang mempunyai clas bg-modal. lalu saya mau mengganti css bagian display
    menjadi flex (display none menjadi display yg di bg-modalx)*/
...
function() {
    /*mencari tag yang mempunyai clas bg-modal. lalu saya mau mengganti css bagian display
    menjadi flex (display none menjadi display yg di bg-modaly)*/
...
function() {
    /*mencari tag yang mempunyai clas bg-modal. lalu saya mau mengganti css bagian display
    menjadi flex (display none menjadi display yg di bg-modalz)*/
